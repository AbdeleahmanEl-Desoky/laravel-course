            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h3><a href="{{-- route('admin.client.index') --}}" style="color: white">{{$clientCount}}</h3>

                            <p><a href="{{-- route('admin.client.index') --}}" style="color: white">@lang('site.categories')</a></p>
                        </div>
                        <div class="icon">
                            <a href="{{-- route('admin.client.index') --}}">   <i class="ion ion-bag"></i></a>
                        </div>
                        <a href="{{-- route('admin.client.index') --}}" class="small-box-footer">@lang('site.read') <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                {{-- @endif --}}
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3><a href="{{-- route('dashboard.products.index') --}}" style="color: white">50</a></h3>
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-red">
                        <div class="inner">
                            <h3><a href="{{-- route('dashboard.orders.index') --}}" style="color: white">50</a></h3>
                ...
                <div class="col-lg-3 col-xs-6">
                    <div class="small-box bg-yellow">
                        <div class="inner">
                            <h3><a href="{{-- route('dashboard.users.index') --}}" style="color: white">50</a></h3>
